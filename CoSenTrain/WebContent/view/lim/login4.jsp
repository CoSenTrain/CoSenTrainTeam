						...
						<table>
							...
							<tr>
								...
								<td><input type="text" name="name" class="inputText"
									required="required" maxlength="5" size="30"
									onblur="nameCheck()" /></td>
							</tr>

							<tr>
								<th >홈페이지*</th>
								<td><label>비밀번호</label> <input type="password" name="password1"
									class="inputText" size="30" /></td>
								<td><label>비밀번호확인</label> <input type="password" name="password2"
									class="inputText" size="30" onblur="passFun()" />
								<td><input type="hidden" name="password"></input></td>
								</td>

							</tr>
							<tr>
								<th >현장발매*</th>
								<td>비밀번호<input type="password" name="password1"
									class="inputText" size="30" /></td>
								<td>비밀번호확인<input type="password" name="password2"
									class="inputText" size="30" onblur="passFun()" />
								<td><input type="hidden" name="password"></input></td>
								</td>
							...
							<tr>
								<th>이메일*</th>
								<td><input type="text" value=""> </td><td><input
									type="button" value="이메일 인증" /></td>
							</tr>
							<tr>
								<th>이메일수신여부</th>
								<td>예<input type="radio" value="yes"> 아니오<input
									type="radio" value="no" />
								</td>
							</tr>
							...
							<tr>
								<th>휴대전화*</th>
								<td><input type="text" name="phone" size="30"></td>
								<td><input type="button" value="휴대전화인증"></td>
